    ...
    <>
      <Container>
        <Typography>
          ...
          uns wenden. 2. Hosting Wir hosten die Inhalte unserer Website bei
          folgendem Anbieter: Externes Hosting Diese Website wird extern
          gehostet. Die personenbezogenen Daten, die auf dieser Website erfasst
          werden, werden auf den Servern des Hosters / der Hoster gespeichert.
          ...
          werden, handeln. Das externe Hosting erfolgt zum Zwecke der
          ...
          einen professionellen Anbieter (Art. 6 Abs. 1 lit. f DSGVO). Sofern
          ...
          Einwilligung ist jederzeit widerrufbar. Unser(e) Hoster wird bzw.
          ...
          Universität Stuttgart BelWü-Koordination Industriestr. 28 70565
          Stuttgart 3. Allgemeine Hinweise und Pflicht­informationen Datenschutz
          ...
          ist: Land Baden-Württemberg – Vertreten durch Beruflichen Schulen
          Bretten Wilhelmstr. 22 75015 Bretten Vertreten durch: Kommissarische
          Schulleiterin: StD’in Nicole Roeder Kommissarisch stellvertretender
          Schulleiter: StD Klaus-Martin Foos Telefon: 0721/936-61600 E-Mail:
          sekretariat@bsb-bretten.de Verantwortliche Stelle ist die natürliche
          ...
          B. Namen, E-Mail-Adressen o. Ä.) entscheidet. Speicherdauer Soweit
          innerhalb dieser Datenschutzerklärung keine speziellere Speicherdauer
          genannt wurde, verbleiben Ihre personenbezogenen Daten bei uns, bis
          der Zweck für die Datenverarbeitung entfällt. Wenn Sie ein
          ...
          ABS. 2 DSGVO). Beschwerde­recht bei der zuständigen Aufsichts­behörde
          ...
          technisch machbar ist. Auskunft, Berichtigung und Löschung Sie haben
          ...
          mitgelesen werden. 4. Datenerfassung auf dieser Website Einwilligung
          mit Borlabs Cookie Unsere Website nutzt die Consent-Technologie von
          Borlabs Cookie, um Ihre Einwilligung zur Speicherung bestimmter
          Cookies in Ihrem Browser oder zum Einsatz bestimmter Technologien
          einzuholen und diese datenschutzkonform zu dokumentieren. Anbieter
          dieser Technologie ist die Borlabs GmbH, Rübenkamp 32, 22305 Hamburg
          (im Folgenden Borlabs). Wenn Sie unsere Website betreten, wird ein
          ...
          Medien Instagram Auf dieser Website sind Funktionen des Dienstes
          ...
          Die Einwilligung ist jederzeit widerrufbar. Soweit mit Hilfe des hier
          beschriebenen Tools personenbezogene Daten auf unserer Website erfasst
          und an Facebook bzw. Instagram weitergeleitet werden, sind wir und die
          ...
          https://privacycenter.instagram.com/policy/. Das Unternehmen verfügt
          ...
          https://www.dataprivacyframework.gov/participant/4452. 6. Plugins und
          Tools Google Fonts (lokales Hosting) Diese Seite nutzt zur
          einheitlichen Darstellung von Schriftarten so genannte Google Fonts,
          die von Google bereitgestellt werden. Die Google Fonts sind lokal
          installiert. Eine Verbindung zu Servern von Google findet dabei nicht
          statt. Weitere Informationen zu Google Fonts finden Sie unter
          https://developers.google.com/fonts/faq und in der
          Datenschutzerklärung von Google:
          https://policies.google.com/privacy?hl=de. Google Maps Diese Seite
          nutzt den Kartendienst Google Maps. Anbieter ist die Google Ireland
          Limited („Google“), Gordon House, Barrow Street, Dublin 4, Irland. Mit
          Hilfe dieses Dienstes können wir Kartenmaterial auf unserer Website
          einbinden. Zur Nutzung der Funktionen von Google Maps ist es
